...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void requesWeather(final String weatherId){
        String weatherUrl = "http://guolin.tech/api/weather?cityid="+weatherId+"&key=de0a6e64084a414ab7d1fac2956af95c";
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (weather !=null&&"ok".equals(weather.status)){
                            ...
                            Toast.makeText(WeatherActivity.this,"获取天气信息失败哦！",Toast.LENGTH_SHORT).show();
                        }
    ...
    private void showWeatherInfo(Weather weather){
        ...
        degreeText.setText("此刻："+degree+weatherInfo);
       ...
       for (Forecast forecast:weather.forecastList){
            ...
            minText.setText(forecast.temperature.min+"℃  至");
